...
<form method='post' action='../src/banco/atualiza_pedido.php'>
    ...
    <div class="form-check form-check-inline">
        <input type="radio" class="form-chekc-input" name="pgto" value="Dinheiro" <?= ($resultDb[0]->pag == 'Dinheiro' ) ? 'checked' : '' ?> /> Dinheiro
    </div>

    <div class="form-check form-check-inline" >
        <input type="radio" class="form-chekc-input" name="pgto" value="Pix" <?= ($resultDb[0]->pag == 'Pix' ) ? 'checked' : '' ?> /> Pix
    </div>
            
    <div class="form-check form-check-inline" >
        <input type="radio" class="form-chekc-input" name="pgto" value="Cartão" <?= ($resultDb[0]->pag == 'Cartão' ) ? 'checked' : '' ?> /> Cartão
    </div>
